  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div
        ...
        ref={printTableRef}
        className="mx-auto max-w-5xl rounded-xl bg-white p-8 shadow-lg ring-1 ring-gray-200 print:max-w-none print:p-7 print:text-[12px] print:leading-relaxed print:shadow-none dark:bg-white">
        {/* Header - Compact */}
        <div className="space-y-2 text-center print:space-y-1">
          <h2 className="text-lg font-semibold tracking-widest text-gray-900 print:text-base print:font-bold">
            {reportTitle.toUpperCase()}
          </h2>
          <h3 className="text-base font-semibold uppercase tracking-wide text-gray-800 print:text-sm print:font-semibold">
            {reportSubtitle}
          </h3>
        </div>

        {/* Info Pegawai - Compact */}
        <div className="mt-8 grid gap-2 text-sm text-gray-900 print:mt-3 print:gap-1 print:text-[12px]">
          <p>
        ...
        <div className="mt-6 space-y-6 print:mt-3 print:space-y-3">
          ...
          <div className="overflow-hidden rounded-lg border border-black">
            <table className="min-w-full border-collapse text-sm text-gray-900 print:text-[12px] dark:text-gray-100">
              <thead>
              ...
              <tbody>
                {groupedRows.length === 0 ? (
                  <tr>
                    <td
                      colSpan={4}
                      className="border-t border-black px-4 py-10 text-center text-sm italic text-gray-500 empty-state print:py-4 print:text-[12px] dark:text-gray-400">
                      {hasFetched
                  ...
                  groupedRows.map((row, index) => (
                    <tr key={row.tanggal} className="align-top">
                      ...
                      <td className="border-t border-black px-3 py-3 text-sm print:px-1 print:py-1 print:text-[12px] dark:text-gray-700">
          ...
          <div className="overflow-hidden rounded-lg border border-black">
            <table className="min-w-full border-collapse text-sm text-gray-900 print:text-[11px] dark:text-gray-100">
              <thead>
                <tr className="bg-gray-100 text-gray-900 dark:text-gray-700">
              ...
              <tbody>
                {lampiranList.length === 0 ? (
                  <tr>
                    <td className="border-t border-black px-4 py-6 text-center text-sm italic text-gray-500 print:py-3 print:text-[12px] dark:text-gray-400">
                      {hasFetched
                  ...
                  <tr>
                    <td className="border-t border-black px-4 py-6 print:px-3 print:py-3">
                      <div className="grid grid-cols-1 items-start gap-6 print:grid-cols-3 print:gap-2 sm:grid-cols-2 lg:grid-cols-3">
                        {lampiranList.map((lampiran) => {
                          ...
                          return (
                            <div
                              ...
                              className="flex w-full flex-col items-center gap-3 text-center print:gap-2">
                              {showImagePreview ? (
                                <div className="flex h-40 w-full items-center justify-center overflow-hidden rounded border border-gray-200 bg-white p-2 shadow-sm print:h-24 print:p-2 dark:border-gray-700">
                                  <img
                                    src={
                                      sanitizedPath || "/images/placeholder.png"
                                    }
                                    width={500}
                                    height={500}
                                    alt={
                                ...
                                <div className="flex h-40 w-full flex-col items-center justify-center gap-2 overflow-hidden rounded border border-gray-200 bg-gray-50 p-3 text-xs text-gray-600 shadow-sm print:h-20 print:gap-1 print:p-2 print:text-[9px] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200">
                                  <span className="text-sm font-semibold uppercase tracking-wide print:text-[10px]">
                              ...
                              <div className="text-sm font-semibold text-[11px] uppercase tracking-wide text-gray-900 print:text-[10px] dark:text-gray-600">
